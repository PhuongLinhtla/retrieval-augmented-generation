...
PROMPTS["translate_to_english"] = "Translate this from Vietnamese to English: {text}\nEnglish:"
PROMPTS["translate_to_vietnamese"] = "Translate this from English to Vietnamese: {text}\nVietnamese:"
